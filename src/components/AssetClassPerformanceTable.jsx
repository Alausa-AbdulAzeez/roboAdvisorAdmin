      ...
      {tableDummyData?.map((tableDummyDatum, index) => {
        ...
        return (
          <tr className="h-[28px] max-2xl:h-[22.4px]" key={index}>
            ...
            <td className="max-2xl:text-[12.8px] leading-[28px] max-2xl:leading-[22.4px] font-[400] text-[#1E1E1E99]">
              {returns}
            </td>
            <td className="max-2xl:text-[12.8px] leading-[28px] max-2xl:leading-[22.4px] font-[400] text-[#1E1E1E99]">
              {volatility}
            ...
            <td className="max-2xl:text-[12.8px] leading-[28px] max-2xl:leading-[22.4px] font-[600] text-[#1E1E1E]">
              {totalValue}
            </td>
          </tr>
        );
