...
import RiskToleranceDistributionPieChart, {
  RiskToleranceDistributionPieChartSmall,
} from "./RiskToleranceDistributionPieChart";

const RiskToleranceDistribution = () => {
  return (
    <div className="overflow-auto bg-white flex flex-col gap-[32px] max-2xl:gap-[25.6px] flex-1 border border-borderColor rounded-[8px] max-2xl:rounded-[6.4px] p-[24px] max-2xl:p-[19.2px] h-full max-md:h-[518px] max-md:flex-none">
      ...
      <div className="max-xl:hidden w-[full] h-[60%] max-2xl:h-[55%]">
        <RiskToleranceDistributionPieChart />
      </div>
      <div className="hidden max-xl:block w-[full] h-[60%] max-2xl:h-[55%]">
        <RiskToleranceDistributionPieChartSmall />
      </div>
