...
const Sidebar = () => {
  ...
  return (
    <div className="max-lg:w-0 h-full max-[300px]:zoomMax300 max-[400px]:zoomMax400 max-sm:zoomMaxSm max-md:zoomMaxMd max-[850px]:zoomMax850 max-xl:zoomMaxXl  w-[271px] max-2xl:w-[216.8px]  bg-white border-r border-borderColor">
