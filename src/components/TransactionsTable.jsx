...
const TransactionsTable = ({ tableHeaders, title, items }) => {
  ...
  // State of Transaction details modal
  ...
  const handleSetRowIndexAndTransaction = (index, transaction) => {
                ...
                {tableHeaders?.map((tableHeader, index) => {
                  return (
                    <th
                      key={index}
                      className={`${
                        (tableHeader === "User ID" && "max-lg:hidden") ||
                        (tableHeader === "Date" && "max-md:hidden") ||
                        (tableHeader === "Status" && "max-md:hidden") ||
                        (tableHeader === "Method" && "max-lg:hidden")
                      } 
                  ...
                  return (
                    <tr>
                      ...
                      <td className="max-md:hidden">
                        {status === "Success" && (
                          <TableActiveStatusIndicator text={"Success"} />
                        )}
                        {status === "Failed" && (
                          <TableInActiveStatusIndicator text={"Failed"} />
                        )}
                        {status === "Pending" && (
                          <TablePendingStatusIndicator text={"Pending"} />
                        )}
                      </td>
                      <td className="max-lg:hidden leading-[28px] max-2xl:leading-[22.4px] text-[16px] max-2xl:text-[12.8px] font-[400] text-silverTextColor">
                        {method}
                      ...
                      <td className="relative">
                        <Icon
                          ...
                          onClick={() =>
                            handleSetRowIndexAndTransaction(index, item)
                          }
                        />
                        {showPopup[index] && (
                          <div
